...
def get_html(start_page):
    ...
    headers = {
        ...
        "pragma": "no-cache",
        "referer": "https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit_v2&action=edit&isNew=1&taskType=77&createType=0&token=477996450&lang=zh_CN&timestamp=1701870446626",
